...
def multi_chart_render(data):
    ...
    """
    source = data.get("clean_csv_url") or data.get("input_url") or data.get("csv_url") or data.get("local_path")
    if not source:
...
"""
    ...
    return _ok({"dashboard_url": dashboard_url, "output_url": dashboard_url, "total": total, "city_total": city_total})
